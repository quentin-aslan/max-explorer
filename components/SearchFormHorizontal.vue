<template>
  ...
  >
    ...
    <div class="w-full lg:w-auto relative">
      ...
      />
      <span
        v-if="!expandForm || isMobile"
        class="lg:hidden text-sm"
      > ⬇ Cliquez pour afficher les autres parametres ⬇ </span>
    </div>
    ...
    >
      <div
        v-if="expandForm || !isMobile"
        class="hidden w-full lg:w-auto relative"
      >
        <label
          class="block text-gray-700 mb-2"
    ...
    >
      <div
        v-if="expandForm || !isMobile"
        class="w-full h-full lg:w-auto relative mt-8"
      >
        <Button
          type="submit"
          label="Rechercher !"
